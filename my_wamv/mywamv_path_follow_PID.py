...
class Wayfinding(Node):
    def __init__(self):
        ...
        self.pos_tol = 0.1       # 位置容差(m)
        self.rot_tol = 0.1       # 角度容差(rad)
        self.v_limit = 3.0        # 最大速度(m/s)
        self.v_const = 0.5        # 接近速度系数
